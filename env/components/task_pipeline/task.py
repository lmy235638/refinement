class Task:
    def __init__(self, start_pos, end_pos, assign_time, end_time, track_name, process_time, task_type, has_good):
    ...
    def __repr__(self):
        return f"Task(start_pos={self.start_pos.name}, end_pos={self.end_pos.name}, " \
               f"assign_time={self.assign_time}, end_time={self.end_time}, track_name='{self.track_name}', " \
